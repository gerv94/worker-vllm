...
DEFAULT_ARGS = {
    ...
    "long_lora_scaling_factors": tuple(map(float, os.getenv("LONG_LORA_SCALING_FACTORS", "").split(",")))
    ...
    or None,
    "typical_acceptance_sampler_posterior_alpha": float(os.getenv("TYPICAL_ACCEPTANCE_SAMPLER_POSTERIOR_ALPHA", 0))
    or None,
...
def get_local_args():
    ...
    with open("/local_model_args.json") as f:
