        ...
        if self.tokenizer is not None:
            ...
            try:
                ...
                class MinimalTokenizerWrapper:
                    def __init__(self, hf_tokenizer_instance):
                ...
                return MinimalTokenizerWrapper(hf_tokenizer)
...
class OpenAIvLLMEngine(vLLMEngine):
    ...
    async def _initialize_engines(self):
        ...
        self.base_model_paths = [BaseModelPath(name=self.engine_args.model, model_path=self.engine_args.model)]
