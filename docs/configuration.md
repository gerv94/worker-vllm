...
| `EMBEDDING_MODEL_NAME`         | `None`              | `str`                                                       | Path of the embedding model weights (e.g., 'intfloat/e5-mistral-7b-instruct', 'BAAI/bge-m3'). Required to enable the `/v1/embeddings` endpoint. Must be a pooling/embedding model supported by vLLM. |
